...
import {deleteCertificate, getCertificates, updateCertificate,createCertificate} from "@/app/(home)/consultant/action";
                ...
                <ModalContent>
                    <Form onSubmit={certificateForm.handleSubmit(async (data) => {
                        try {
                            ...
                            if (editingCertificate) {
                                result = await updateCertificate(editingCertificate.certificate_id, data);
